...
const { onFileChange, url, isImageUploaded, isUploading, uploadProgress } = useImage()
    ...
    <div class="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
        ...
        <div class="max-w-4xl mx-auto px-6 py-8">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-gray-900 mb-2">✨ Agregar Nuevo Producto</h1>
                <p class="text-lg text-gray-600">Completa la información para añadir un producto a tu catálogo</p>
                <div class="mt-4 w-24 h-1 bg-gradient-to-r from-emerald-500 to-teal-500 mx-auto rounded-full"></div>
            </div>
                ...
                <div class="p-8">
                    <FormKit type="form" 
                        ...
                        <div class="bg-emerald-50 rounded-xl p-6 border border-emerald-100">
                            ...
                            <div v-if="isUploading" class="mb-6">
                                <div class="flex items-center mb-2">
                                    ...
                                    <p class="text-emerald-600 font-medium">Subiendo imagen a Supabase...</p>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                                    <div class="bg-gradient-to-r from-emerald-500 to-teal-500 h-3 rounded-full transition-all duration-300 ease-out" 
                                         :style="`width: ${uploadProgress}%`"></div>
                                </div>
                                <p class="text-sm text-gray-500 mt-1">{{ uploadProgress }}% completado</p>
                            </div>
                            ...
                            <div v-if="isImageUploaded" class="mb-4">
                                <div class="flex items-center mb-3">
                                    ...
                                    <p class="font-medium text-green-600">Imagen subida exitosamente</p>
                                </div>
                                ...
                                <p class="text-sm text-gray-500 mt-2">💾 Almacenada en Supabase Storage</p>
                            </div>
                        </div>
                            ...
                            <div class="bg-emerald-50 rounded-xl p-6 border border-emerald-100">
                                ...
                                <div v-if="formData.price" class="mt-4 p-3 bg-white rounded-lg border border-green-200">
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm text-gray-600">Precio final:</span>
                        ...
                        <div class="bg-emerald-50 rounded-xl p-6 border border-emerald-100">
                            ...
                            <div v-if="formData.availability" class="mt-4 p-3 bg-white rounded-lg border border-teal-200">
                                <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900">
                                            {{ isFormValid ? 'Listo para crear' : 'Completar información' }}
                                        </h3>
                                        <p class="text-sm text-gray-600">
                                            {{ isFormValid 
                                                ? 'Todos los campos están completos. ¡Puedes crear el producto!' 
                                                : 'Completa todos los campos para poder crear el producto.' 
                                            }}
                                        </p>
                                    </div>
                                </div>
